...
<?php if ($this->session->flashdata('hapus')){ ?>
  ...
  <?php if ($this->session->flashdata('error_hapus')){ ?>
    <script>
      swal({
        title: "Error!",
              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                            ...
                            <td>
                             <center>
                              <a href="<?=base_url();?>assets/gambar/<?=$gambar_produk?>"
                                target="_blank">
                                <img src="<?=base_url();?>assets/gambar/<?=$gambar_produk?>" width="25%">
                              </a>
                            </center>
                          </td>
                          <td><?=$harga_produk?></td>
                    ...
                    <!--Modal Edit -->
                    <div class="modal fade" id="edit_data_produk<?= $id_produk?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="<?=base_url();?>Produk/edit_produk" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="<?=$nama_produk?>" required>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gambar_produk_old" name="gambar_produk_old" value="<?=$gambar_produk?>" hidden>
                              </div>

                              <div class="form-group">
                                <label for="harga_produk">Harga Produk</label>
                                <input type="number" class="form-control" id="harga_produk" name="harga_produk" value="<?=$harga_produk?>" required>
                              </div>

                              <div class="form-group">
                                <label for="diskon">Diskon</label>
                                <input type="number" class="form-control" id="diskon" name="diskon" value="<?=$diskon?>" required>
                              </div>

                              <div class="form-group">
                                <label for="jumlah_produk">Jumlah Produk</label>
                                <input type="number" class="form-control" id="jumlah_produk" name="jumlah_produk" value="<?=$jumlah_produk?>" required>
                              </div>

                              <div class="form-group">
                                <label for="tanggal_kadaluarsa">Tanggal Kadaluarsa</label>
                                <input type="date" class="form-control" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" value="<?=$tanggal_kadaluarsa?>" required>
                              </div>

                              <div class="form-group">
                                <label for="tanggal_produksi">Tanggal Produksi</label>
                                <input type="date" class="form-control" id="tanggal_produksi" name="tanggal_produksi" value="<?=$tanggal_produksi?>" required>
                              </div>

                              <div class="form-group">
                                <label for="Deskripsi">Deskripsi</label>
                                <textarea class="form-control" id="deskripsi" name="deskripsi"
                                rows="3" required><?=$deskripsi_produk?></textarea>
                              </div>
